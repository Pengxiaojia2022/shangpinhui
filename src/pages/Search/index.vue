        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li v-bind:class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    >综合<span
                      v-show="isOne"
                      class="iconfont"
...
export default {
  ...
  methods: {
    ...
    changeOrder(type) {
      ...
      // 点击有两种情况，一是一直点击的同一个类型的排序【那么只用切换升序还是降序】，二是点击的不同排序【那么就把不同排序置为默认降序】
      let newOrder = "";
      if (type == originType) {
        newOrder = `${originType}:${originSort == "desc" ? "asc" : "desc"}`;
      } else {
        newOrder = `${type}:desc`;
      }
